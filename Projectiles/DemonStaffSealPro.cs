...
{
    public class DemonStaffSealPro : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, ModContent.ProjectileType<Projectiles.DemonStaffSeal>(), 1, 1f, Main.myPlayer, 1f, (float)n);
            projectile.Kill();
        }
    }
}
